  ...
  return (
    <footer className="bg-blue-50/70  mt-20">
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center gap-2">
              <Image src={logo} width={50} height={50} className="h-8 w-8" alt="FlowBite Logo" />
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center ">Hecho con ❤️ por <Link href="/" className="hover:underline">Cifu</Link>.
        </span>
